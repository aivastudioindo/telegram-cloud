...
//
// State grup aktif & mapping kategori disimpan di DENO KV (persisten,
// gratis di Deno Deploy) — bukan memory, agar tidak hilang saat restart
// dan konsisten antar instance.
